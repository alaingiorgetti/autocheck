...
(* Why3 assumption *)
Definition trans {a:Type} {a_WT:WhyType a}
    (rel:a -> a -> Init.Datatypes.bool) : Prop :=
  forall (x:a) (y:a) (z:a), ((rel x y) = Init.Datatypes.true) ->
  ((rel y z) = Init.Datatypes.true) -> ((rel x z) = Init.Datatypes.true).

(* Why3 assumption *)
Definition asymm {a:Type} {a_WT:WhyType a}
    (rel:a -> a -> Init.Datatypes.bool) : Prop :=
  forall (x:a) (y:a), ((rel x y) = Init.Datatypes.true) ->
  ~ ((rel y x) = Init.Datatypes.true).

(* Why3 assumption *)
Definition partialStrictOrder {a:Type} {a_WT:WhyType a}
    (rel:a -> a -> Init.Datatypes.bool) : Prop :=
  trans rel /\ asymm rel.

(* Why3 assumption *)
Definition trichotomy {a:Type} {a_WT:WhyType a}
    (rel:a -> a -> Init.Datatypes.bool) : Prop :=
  forall (x:a) (y:a),
...
(* Why3 assumption *)
Definition totalStrictOrder {a:Type} {a_WT:WhyType a}
    (rel:a -> a -> Init.Datatypes.bool) : Prop :=
  partialStrictOrder rel /\ trichotomy rel.

Axiom irrefl :
  forall {a:Type} {a_WT:WhyType a},
  forall (lt:a -> a -> Init.Datatypes.bool), asymm lt -> forall (a1:a),
  ((lt a1 a1) = Init.Datatypes.false).
...
(* Why3 assumption *)
Definition lt_map (m:bint -> bint) (i:bint) (j:bint) : Prop :=
  lt_bint (m i) (m j).

Parameter lt_map_closure:
  (bint -> bint) -> bint -> bint -> Init.Datatypes.bool.

Axiom lt_map_closure_def :
  forall (y:bint -> bint) (y1:bint) (y2:bint),
  ((lt_map_closure y y1 y2) = Init.Datatypes.true) <-> lt_map y y1 y2.

Axiom lt_map_bij_sto :
  forall (sigma:bint -> bint), bijective sigma ->
  totalStrictOrder (fun (i:bint) => lt_map_closure sigma i).
