...
Axiom is_permut_split :
  forall (a:array Z) (b:array Z) (l:Z),
  (((0%Z <= l)%Z /\ ((l < (length a))%Z /\ ((length a) = (length b)))) /\
   ((is_permut a) /\
    ((is_permut b) /\ ((permut a b 0%Z (length a)) /\ (permut a b 0%Z l))))) ->
...
Axiom is_permut_split_imply_permut_sub :
  ...
  (((0%Z <= l)%Z /\ ((l < (length a))%Z /\ ((length a) = (length b)))) /\
   ((is_permut a) /\
    ((is_permut b) /\
     ((permut a b 0%Z (length a)) /\ (array_eq_sub a b 0%Z l))))) ->
...
Axiom permut_trans :
  forall (a1:array Z) (a2:array Z) (a3:array Z), forall (l:Z) (u:Z),
...
Axiom array_eq_sub_trans :
  forall (a1:array Z) (a2:array Z) (a3:array Z), forall (l:Z) (u:Z),
  (array_eq_sub a1 a2 l u) -> (array_eq_sub a2 a3 l u) ->
  array_eq_sub a1 a3 l u.
...
(* Why3 goal *)
Theorem inc_permut :
  forall (a:array Z) (b:array Z) (r:Z) (j:Z),
  (((0%Z <= r)%Z /\
      ...
      ((is_inc_sub b (r + 1%Z)%Z (length a)) /\
       ((lt_lex_at a b r) /\
        ((permut_sub a b r (length a)) /\
         ((im_sup1 a r j) /\
          ((im_sup2 a r j) /\ ((mixfix_lbrb b r) = (mixfix_lbrb a j))))))))))) ->
  inc a b.
Proof.
(*Why3 intros a b r j
